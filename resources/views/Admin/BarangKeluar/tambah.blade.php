            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="bknoref" class="form-label">No Reference <span class="text-danger">*</span></label>
                            <input type="text" name="bknoref" readonly class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
...
<script>
    ...
    const bknoref = $("input[name='bknoref']").val();
    const tglkeluar = $("input[name='tglkeluar']").val();
