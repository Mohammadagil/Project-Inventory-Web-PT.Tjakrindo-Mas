            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="bknorefU" class="form-label">No Reference <span class="text-danger">*</span></label>
                            <input type="text" name="bknorefU" readonly class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
...
<script>
    ...
    function submitFormU() {
        ...
        const bknoref = $("input[name='bknorefU']").val();
        const tglkeluar = $("input[name='tglkeluarU']").val();
        const kdbarang = $("input[name='kdbarangU']").val();
        const tujuan = $("input[name='tujuanU']").val();
        const jml = $("input[name='jmlU']").val();
