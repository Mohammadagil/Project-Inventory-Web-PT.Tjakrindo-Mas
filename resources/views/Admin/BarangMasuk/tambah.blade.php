            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="bmnoref" class="form-label">Kode Barang Masuk <span class="text-danger">*</span></label>
                            <input type="text" name="bmnoref" readonly class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
...
<script>
    ...
    function submitForm() {
        ...
        const bmnoref = $("input[name='bmnoref']").val();
        const tglmasuk = $("input[name='tglmasuk']").val();
