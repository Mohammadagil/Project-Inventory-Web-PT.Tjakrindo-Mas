            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="bmnorefU" class="form-label">No Reference <span class="text-danger">*</span></label>
                            <input type="text" name="bmnorefU" readonly class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
...
<script>
    ...
    function submitFormU() {
        ...
        const bmnoref = $("input[name='bmnorefU']").val();
        const tglmasuk = $("input[name='tglmasukU']").val();
        const kdbarang = $("input[name='kdbarangU']").val();
        const customer = $("select[name='customerU']").val();
        const jml = $("input[name='jmlU']").val();
